package fasciaSegmentation.metrics;
...
import fasciaSegmentation.utils.Utils;
import fasciaSegmentation.utils.WatershedTransform2D;
...
public class RandError extends Metrics
{
			...
			double stepThreshold)
	{
	    ...
	    // fasciaSegmentation.utils.Utils.plotPrecisionRecall( stats );
	    double maxFScore = 0;
